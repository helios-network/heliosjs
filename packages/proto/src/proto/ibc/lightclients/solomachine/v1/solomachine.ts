...
export const ClientState: MessageFns<ClientState> = {
    ...
    while (reader.pos < end) {
      ...
      switch (tag >>> 3) {
        ...
        case 2: {
          ...
          message.frozenSequence = longToNumber(reader.uint64());
          continue;
        }
        case 3: {
          if (tag !== 26) {
  ...
  fromJSON(object: any): ClientState {
    return {
      ...
      frozenSequence: isSet(object.frozenSequence) ? globalThis.Number(object.frozenSequence) : 0,
  ...
  toJSON(message: ClientState): unknown {
    ...
    if (message.frozenSequence !== 0) {
      obj.frozenSequence = Math.round(message.frozenSequence);
    }
    if (message.consensusState !== undefined) {
