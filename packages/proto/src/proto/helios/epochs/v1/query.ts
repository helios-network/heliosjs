...
export namespace helios.epochs.v1 {
    ...
    export class QueryEpochsInfoResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            epochs?: dependency_4.helios.epochs.v1.EpochInfo[];
        ...
        get epochs() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_4.helios.epochs.v1.EpochInfo, 1) as dependency_4.helios.epochs.v1.EpochInfo[];
        }
        set epochs(value: dependency_4.helios.epochs.v1.EpochInfo[]) {
        ...
        static fromObject(data: {
            epochs?: ReturnType<typeof dependency_4.helios.epochs.v1.EpochInfo.prototype.toObject>[];
            ...
            if (data.epochs != null) {
                message.epochs = data.epochs.map(item => dependency_4.helios.epochs.v1.EpochInfo.fromObject(item));
            }
            if (data.pagination != null) {
        ...
        toObject() {
            ...
            if (this.epochs != null) {
                data.epochs = this.epochs.map((item: dependency_4.helios.epochs.v1.EpochInfo) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.epochs.length)
                writer.writeRepeatedMessage(1, this.epochs, (item: dependency_4.helios.epochs.v1.EpochInfo) => item.serialize(writer));
            if (this.has_pagination)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryEpochsInfoResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.epochs, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_4.helios.epochs.v1.EpochInfo.deserialize(reader), dependency_4.helios.epochs.v1.EpochInfo));
                        break;
                    case 2:
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            EpochInfos: {
                path: "/helios.epochs.v1.Query/EpochInfos",
                requestStream: false,
            ...
            CurrentEpoch: {
                path: "/helios.epochs.v1.Query/CurrentEpoch",
                requestStream: false,
                responseStream: false,
