...
export namespace helios.inflation.v1 {
    ...
    export class Params extends pb_1.Message {
        constructor(data?: any[] | {
            mint_denom?: string;
            exponential_calculation?: dependency_2.helios.inflation.v1.ExponentialCalculation;
            inflation_distribution?: dependency_2.helios.inflation.v1.InflationDistribution;
        ...
        get exponential_calculation() {
            return pb_1.Message.getWrapperField(this, dependency_2.helios.inflation.v1.ExponentialCalculation, 2) as dependency_2.helios.inflation.v1.ExponentialCalculation;
        }
        set exponential_calculation(value: dependency_2.helios.inflation.v1.ExponentialCalculation) {
            pb_1.Message.setWrapperField(this, 2, value);
        }
        get inflation_distribution() {
            return pb_1.Message.getWrapperField(this, dependency_2.helios.inflation.v1.InflationDistribution, 3) as dependency_2.helios.inflation.v1.InflationDistribution;
        }
        set inflation_distribution(value: dependency_2.helios.inflation.v1.InflationDistribution) {
        ...
        static fromObject(data: {
            mint_denom?: string;
            exponential_calculation?: ReturnType<typeof dependency_2.helios.inflation.v1.ExponentialCalculation.prototype.toObject>;
            inflation_distribution?: ReturnType<typeof dependency_2.helios.inflation.v1.InflationDistribution.prototype.toObject>;
            enable_inflation?: boolean;
        }) {
            ...
            if (data.exponential_calculation != null) {
                message.exponential_calculation = dependency_2.helios.inflation.v1.ExponentialCalculation.fromObject(data.exponential_calculation);
            }
            if (data.inflation_distribution != null) {
                message.inflation_distribution = dependency_2.helios.inflation.v1.InflationDistribution.fromObject(data.inflation_distribution);
            }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.exponential_calculation, () => message.exponential_calculation = dependency_2.helios.inflation.v1.ExponentialCalculation.deserialize(reader));
                        break;
                    case 3:
                        reader.readMessage(message.inflation_distribution, () => message.inflation_distribution = dependency_2.helios.inflation.v1.InflationDistribution.deserialize(reader));
                        break;
                    case 4:
