...
export namespace helios.inflation.v1 {
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            params?: dependency_4.helios.inflation.v1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_4.helios.inflation.v1.Params, 1) as dependency_4.helios.inflation.v1.Params;
        }
        set params(value: dependency_4.helios.inflation.v1.Params) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_params() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            params?: ReturnType<typeof dependency_4.helios.inflation.v1.Params.prototype.toObject>;
        }): QueryParamsResponse {
            const message = new QueryParamsResponse({});
            if (data.params != null) {
                message.params = dependency_4.helios.inflation.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_4.helios.inflation.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            Period: {
                path: "/helios.inflation.v1.Query/Period",
                requestStream: false,
            ...
            EpochMintProvision: {
                path: "/helios.inflation.v1.Query/EpochMintProvision",
                requestStream: false,
                responseStream: false,
            ...
            SkippedEpochs: {
                path: "/helios.inflation.v1.Query/SkippedEpochs",
                requestStream: false,
                responseStream: false,
            ...
            TotalSupply: {
                path: "/helios.inflation.v1.Query/TotalSupply",
                requestStream: false,
                responseStream: false,
            ...
            InflationRate: {
                path: "/helios.inflation.v1.Query/InflationRate",
                requestStream: false,
                responseStream: false,
            ...
            Params: {
                path: "/helios.inflation.v1.Query/Params",
                requestStream: false,
                responseStream: false,
