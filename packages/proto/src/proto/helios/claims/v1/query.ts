...
export namespace helios.claims.v1 {
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            params?: dependency_6.helios.claims.v1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_6.helios.claims.v1.Params, 1) as dependency_6.helios.claims.v1.Params;
        }
        set params(value: dependency_6.helios.claims.v1.Params) {
        ...
        static fromObject(data: {
            params?: ReturnType<typeof dependency_6.helios.claims.v1.Params.prototype.toObject>;
        }): QueryParamsResponse {
            const message = new QueryParamsResponse({});
            if (data.params != null) {
                message.params = dependency_6.helios.claims.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_6.helios.claims.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryClaimsRecordsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            claims?: dependency_5.helios.claims.v1.ClaimsRecordAddress[];
        ...
        get claims() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_5.helios.claims.v1.ClaimsRecordAddress, 1) as dependency_5.helios.claims.v1.ClaimsRecordAddress[];
        }
        set claims(value: dependency_5.helios.claims.v1.ClaimsRecordAddress[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        get pagination() {
        ...
        static fromObject(data: {
            claims?: ReturnType<typeof dependency_5.helios.claims.v1.ClaimsRecordAddress.prototype.toObject>[];
            ...
            if (data.claims != null) {
                message.claims = data.claims.map(item => dependency_5.helios.claims.v1.ClaimsRecordAddress.fromObject(item));
            }
            if (data.pagination != null) {
        ...
        toObject() {
            ...
            if (this.claims != null) {
                data.claims = this.claims.map((item: dependency_5.helios.claims.v1.ClaimsRecordAddress) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.claims.length)
                writer.writeRepeatedMessage(1, this.claims, (item: dependency_5.helios.claims.v1.ClaimsRecordAddress) => item.serialize(writer));
            if (this.has_pagination)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryClaimsRecordsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.claims, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_5.helios.claims.v1.ClaimsRecordAddress.deserialize(reader), dependency_5.helios.claims.v1.ClaimsRecordAddress));
                        break;
                    case 2:
    ...
    export class QueryClaimsRecordResponse extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            ...
            claims?: dependency_5.helios.claims.v1.Claim[];
        }) {
            super();
        ...
        get claims() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_5.helios.claims.v1.Claim, 2) as dependency_5.helios.claims.v1.Claim[];
        }
        set claims(value: dependency_5.helios.claims.v1.Claim[]) {
            pb_1.Message.setRepeatedWrapperField(this, 2, value);
        }
        static fromObject(data: {
            initial_claimable_amount?: string;
            claims?: ReturnType<typeof dependency_5.helios.claims.v1.Claim.prototype.toObject>[];
            ...
            if (data.claims != null) {
                message.claims = data.claims.map(item => dependency_5.helios.claims.v1.Claim.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.claims != null) {
                data.claims = this.claims.map((item: dependency_5.helios.claims.v1.Claim) => item.toObject());
            }
            return data;
        }
        serialize(): Uint8Array;
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.claims.length)
                writer.writeRepeatedMessage(2, this.claims, (item: dependency_5.helios.claims.v1.Claim) => item.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        }
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.claims, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_5.helios.claims.v1.Claim.deserialize(reader), dependency_5.helios.claims.v1.Claim));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            TotalUnclaimed: {
                path: "/helios.claims.v1.Query/TotalUnclaimed",
                requestStream: false,
            ...
            Params: {
                path: "/helios.claims.v1.Query/Params",
                requestStream: false,
                responseStream: false,
            ...
            ClaimsRecords: {
                path: "/helios.claims.v1.Query/ClaimsRecords",
                requestStream: false,
                responseStream: false,
            ...
            ClaimsRecord: {
                path: "/helios.claims.v1.Query/ClaimsRecord",
                requestStream: false,
                responseStream: false,
