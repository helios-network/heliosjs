...
export namespace helios.claims.v1 {
    export class GenesisState extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            params?: Params;
            claims_records?: dependency_4.helios.claims.v1.ClaimsRecordAddress[];
        }) {
            super();
        ...
        get claims_records() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_4.helios.claims.v1.ClaimsRecordAddress, 2) as dependency_4.helios.claims.v1.ClaimsRecordAddress[];
        }
        set claims_records(value: dependency_4.helios.claims.v1.ClaimsRecordAddress[]) {
            pb_1.Message.setRepeatedWrapperField(this, 2, value);
        }
        static fromObject(data: {
            params?: ReturnType<typeof Params.prototype.toObject>;
            claims_records?: ReturnType<typeof dependency_4.helios.claims.v1.ClaimsRecordAddress.prototype.toObject>[];
        }): GenesisState {
            ...
            if (data.claims_records != null) {
                message.claims_records = data.claims_records.map(item => dependency_4.helios.claims.v1.ClaimsRecordAddress.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.claims_records != null) {
                data.claims_records = this.claims_records.map((item: dependency_4.helios.claims.v1.ClaimsRecordAddress) => item.toObject());
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.claims_records.length)
                writer.writeRepeatedMessage(2, this.claims_records, (item: dependency_4.helios.claims.v1.ClaimsRecordAddress) => item.serialize(writer));
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.claims_records, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_4.helios.claims.v1.ClaimsRecordAddress.deserialize(reader), dependency_4.helios.claims.v1.ClaimsRecordAddress));
                        break;
