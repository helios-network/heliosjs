...
export namespace helios.incentives.v1 {
    ...
    export class QueryIncentivesResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            incentives?: dependency_4.helios.incentives.v1.Incentive[];
        ...
        get incentives() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_4.helios.incentives.v1.Incentive, 1) as dependency_4.helios.incentives.v1.Incentive[];
        }
        set incentives(value: dependency_4.helios.incentives.v1.Incentive[]) {
        ...
        static fromObject(data: {
            incentives?: ReturnType<typeof dependency_4.helios.incentives.v1.Incentive.prototype.toObject>[];
            ...
            if (data.incentives != null) {
                message.incentives = data.incentives.map(item => dependency_4.helios.incentives.v1.Incentive.fromObject(item));
            }
            if (data.pagination != null) {
        ...
        toObject() {
            ...
            if (this.incentives != null) {
                data.incentives = this.incentives.map((item: dependency_4.helios.incentives.v1.Incentive) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.incentives.length)
                writer.writeRepeatedMessage(1, this.incentives, (item: dependency_4.helios.incentives.v1.Incentive) => item.serialize(writer));
            if (this.has_pagination)
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryIncentivesResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.incentives, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_4.helios.incentives.v1.Incentive.deserialize(reader), dependency_4.helios.incentives.v1.Incentive));
                        break;
                    case 2:
    ...
    export class QueryIncentiveResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            incentive?: dependency_4.helios.incentives.v1.Incentive;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get incentive() {
            return pb_1.Message.getWrapperField(this, dependency_4.helios.incentives.v1.Incentive, 1) as dependency_4.helios.incentives.v1.Incentive;
        }
        set incentive(value: dependency_4.helios.incentives.v1.Incentive) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_incentive() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            incentive?: ReturnType<typeof dependency_4.helios.incentives.v1.Incentive.prototype.toObject>;
        }): QueryIncentiveResponse {
            const message = new QueryIncentiveResponse({});
            if (data.incentive != null) {
                message.incentive = dependency_4.helios.incentives.v1.Incentive.fromObject(data.incentive);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryIncentiveResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.incentive, () => message.incentive = dependency_4.helios.incentives.v1.Incentive.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export class QueryGasMetersResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            gas_meters?: dependency_4.helios.incentives.v1.GasMeter[];
            pagination?: dependency_1.cosmos.base.query.v1beta1.PageResponse;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [1], this.#one_of_decls);
        ...
        get gas_meters() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_4.helios.incentives.v1.GasMeter, 1) as dependency_4.helios.incentives.v1.GasMeter[];
        }
        set gas_meters(value: dependency_4.helios.incentives.v1.GasMeter[]) {
            pb_1.Message.setRepeatedWrapperField(this, 1, value);
        }
        get pagination() {
            return pb_1.Message.getWrapperField(this, dependency_1.cosmos.base.query.v1beta1.PageResponse, 2) as dependency_1.cosmos.base.query.v1beta1.PageResponse;
        ...
        static fromObject(data: {
            gas_meters?: ReturnType<typeof dependency_4.helios.incentives.v1.GasMeter.prototype.toObject>[];
            pagination?: ReturnType<typeof dependency_1.cosmos.base.query.v1beta1.PageResponse.prototype.toObject>;
        }): QueryGasMetersResponse {
            const message = new QueryGasMetersResponse({});
            if (data.gas_meters != null) {
                message.gas_meters = data.gas_meters.map(item => dependency_4.helios.incentives.v1.GasMeter.fromObject(item));
            }
            if (data.pagination != null) {
                message.pagination = dependency_1.cosmos.base.query.v1beta1.PageResponse.fromObject(data.pagination);
            }
        ...
        toObject() {
            ...
            if (this.gas_meters != null) {
                data.gas_meters = this.gas_meters.map((item: dependency_4.helios.incentives.v1.GasMeter) => item.toObject());
            }
            if (this.pagination != null) {
                data.pagination = this.pagination.toObject();
            }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.gas_meters.length)
                writer.writeRepeatedMessage(1, this.gas_meters, (item: dependency_4.helios.incentives.v1.GasMeter) => item.serialize(writer));
            if (this.has_pagination)
                writer.writeMessage(2, this.pagination, () => this.pagination.serialize(writer));
            if (!w)
                return writer.getResultBuffer();
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryGasMetersResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.gas_meters, () => pb_1.Message.addToRepeatedWrapperField(message, 1, dependency_4.helios.incentives.v1.GasMeter.deserialize(reader), dependency_4.helios.incentives.v1.GasMeter));
                        break;
                    case 2:
                        reader.readMessage(message.pagination, () => message.pagination = dependency_1.cosmos.base.query.v1beta1.PageResponse.deserialize(reader));
                        break;
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            params?: dependency_3.helios.incentives.v1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_3.helios.incentives.v1.Params, 1) as dependency_3.helios.incentives.v1.Params;
        }
        set params(value: dependency_3.helios.incentives.v1.Params) {
            pb_1.Message.setWrapperField(this, 1, value);
        }
        get has_params() {
            return pb_1.Message.getField(this, 1) != null;
        ...
        static fromObject(data: {
            params?: ReturnType<typeof dependency_3.helios.incentives.v1.Params.prototype.toObject>;
        }): QueryParamsResponse {
            const message = new QueryParamsResponse({});
            if (data.params != null) {
                message.params = dependency_3.helios.incentives.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_3.helios.incentives.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            Incentives: {
                path: "/helios.incentives.v1.Query/Incentives",
                requestStream: false,
            ...
            Incentive: {
                path: "/helios.incentives.v1.Query/Incentive",
                requestStream: false,
                responseStream: false,
            ...
            GasMeters: {
                path: "/helios.incentives.v1.Query/GasMeters",
                requestStream: false,
                responseStream: false,
            ...
            GasMeter: {
                path: "/helios.incentives.v1.Query/GasMeter",
                requestStream: false,
                responseStream: false,
            ...
            AllocationMeters: {
                path: "/helios.incentives.v1.Query/AllocationMeters",
                requestStream: false,
                responseStream: false,
            ...
            AllocationMeter: {
                path: "/helios.incentives.v1.Query/AllocationMeter",
                requestStream: false,
                responseStream: false,
            ...
            Params: {
                path: "/helios.incentives.v1.Query/Params",
                requestStream: false,
                responseStream: false,
