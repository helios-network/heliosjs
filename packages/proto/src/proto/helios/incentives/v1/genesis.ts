...
export namespace helios.incentives.v1 {
    export class GenesisState extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            params?: Params;
            incentives?: dependency_1.helios.incentives.v1.Incentive[];
            gas_meters?: dependency_1.helios.incentives.v1.GasMeter[];
        }) {
            super();
        ...
        get incentives() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.helios.incentives.v1.Incentive, 2) as dependency_1.helios.incentives.v1.Incentive[];
        }
        set incentives(value: dependency_1.helios.incentives.v1.Incentive[]) {
            pb_1.Message.setRepeatedWrapperField(this, 2, value);
        }
        get gas_meters() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.helios.incentives.v1.GasMeter, 3) as dependency_1.helios.incentives.v1.GasMeter[];
        }
        set gas_meters(value: dependency_1.helios.incentives.v1.GasMeter[]) {
            pb_1.Message.setRepeatedWrapperField(this, 3, value);
        }
        static fromObject(data: {
            params?: ReturnType<typeof Params.prototype.toObject>;
            incentives?: ReturnType<typeof dependency_1.helios.incentives.v1.Incentive.prototype.toObject>[];
            gas_meters?: ReturnType<typeof dependency_1.helios.incentives.v1.GasMeter.prototype.toObject>[];
        }): GenesisState {
            ...
            if (data.incentives != null) {
                message.incentives = data.incentives.map(item => dependency_1.helios.incentives.v1.Incentive.fromObject(item));
            }
            if (data.gas_meters != null) {
                message.gas_meters = data.gas_meters.map(item => dependency_1.helios.incentives.v1.GasMeter.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.incentives != null) {
                data.incentives = this.incentives.map((item: dependency_1.helios.incentives.v1.Incentive) => item.toObject());
            }
            if (this.gas_meters != null) {
                data.gas_meters = this.gas_meters.map((item: dependency_1.helios.incentives.v1.GasMeter) => item.toObject());
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.incentives.length)
                writer.writeRepeatedMessage(2, this.incentives, (item: dependency_1.helios.incentives.v1.Incentive) => item.serialize(writer));
            if (this.gas_meters.length)
                writer.writeRepeatedMessage(3, this.gas_meters, (item: dependency_1.helios.incentives.v1.GasMeter) => item.serialize(writer));
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.incentives, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.helios.incentives.v1.Incentive.deserialize(reader), dependency_1.helios.incentives.v1.Incentive));
                        break;
                    case 3:
                        reader.readMessage(message.gas_meters, () => pb_1.Message.addToRepeatedWrapperField(message, 3, dependency_1.helios.incentives.v1.GasMeter.deserialize(reader), dependency_1.helios.incentives.v1.GasMeter));
                        break;
