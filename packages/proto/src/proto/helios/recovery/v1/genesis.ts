...
//   protoc               v5.29.1
// source: helios/recovery/v1/genesis.proto

/* eslint-disable */
import { BinaryReader, BinaryWriter } from "@bufbuild/protobuf/wire";
import { Duration } from "../../../google/protobuf/duration";

export const protobufPackage = "helios.recovery.v1";
...
export const Params: MessageFns<Params> = {
  encode(message: Params, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    ...
    if (message.packetTimeoutDuration !== undefined) {
      Duration.encode(message.packetTimeoutDuration, writer.uint32(18).fork()).join();
    }
    return writer;
  },
  ...
  fromJSON(object: any): Params {
    return {
      enableRecovery: isSet(object.enableRecovery) ? globalThis.Boolean(object.enableRecovery) : false,
  ...
  toJSON(message: Params): unknown {
    ...
    if (message.packetTimeoutDuration !== undefined) {
      obj.packetTimeoutDuration = Duration.toJSON(message.packetTimeoutDuration);
    }
    return obj;
  },
