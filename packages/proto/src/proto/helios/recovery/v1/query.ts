 ...
 * source: helios/recovery/v1/query.proto
...
export namespace helios.recovery.v1 {
    ...
    export class QueryParamsResponse extends pb_1.Message {
        #one_of_decls: number[][] = [];
        constructor(data?: any[] | {
            params?: dependency_3.helios.recovery.v1.Params;
        }) {
            super();
            pb_1.Message.initialize(this, Array.isArray(data) ? data : [], 0, -1, [], this.#one_of_decls);
            if (!Array.isArray(data) && typeof data == "object") {
        ...
        get params() {
            return pb_1.Message.getWrapperField(this, dependency_3.helios.recovery.v1.Params, 1) as dependency_3.helios.recovery.v1.Params;
        }
        set params(value: dependency_3.helios.recovery.v1.Params) {
        ...
        static fromObject(data: {
            params?: ReturnType<typeof dependency_3.helios.recovery.v1.Params.prototype.toObject>;
        }): QueryParamsResponse {
            const message = new QueryParamsResponse({});
            if (data.params != null) {
                message.params = dependency_3.helios.recovery.v1.Params.fromObject(data.params);
            }
            return message;
        }
        toObject() {
        ...
        static deserialize(bytes: Uint8Array | pb_1.BinaryReader): QueryParamsResponse {
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        reader.readMessage(message.params, () => message.params = dependency_3.helios.recovery.v1.Params.deserialize(reader));
                        break;
                    default: reader.skipField();
                }
            }
    ...
    export abstract class UnimplementedQueryService {
        static definition = {
            Params: {
                path: "/helios.recovery.v1.Query/Params",
                requestStream: false,
