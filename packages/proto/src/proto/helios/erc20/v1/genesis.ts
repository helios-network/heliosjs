...
export namespace helios.erc20.v1 {
    export class GenesisState extends pb_1.Message {
        ...
        constructor(data?: any[] | {
            params?: Params;
            token_pairs?: dependency_1.helios.erc20.v1.TokenPair[];
        }) {
            super();
        ...
        get token_pairs() {
            return pb_1.Message.getRepeatedWrapperField(this, dependency_1.helios.erc20.v1.TokenPair, 2) as dependency_1.helios.erc20.v1.TokenPair[];
        }
        set token_pairs(value: dependency_1.helios.erc20.v1.TokenPair[]) {
            pb_1.Message.setRepeatedWrapperField(this, 2, value);
        }
        static fromObject(data: {
            params?: ReturnType<typeof Params.prototype.toObject>;
            token_pairs?: ReturnType<typeof dependency_1.helios.erc20.v1.TokenPair.prototype.toObject>[];
        }): GenesisState {
            ...
            if (data.token_pairs != null) {
                message.token_pairs = data.token_pairs.map(item => dependency_1.helios.erc20.v1.TokenPair.fromObject(item));
            }
            return message;
        }
        toObject() {
            ...
            if (this.token_pairs != null) {
                data.token_pairs = this.token_pairs.map((item: dependency_1.helios.erc20.v1.TokenPair) => item.toObject());
            }
            return data;
        }
        ...
        serialize(w?: pb_1.BinaryWriter): Uint8Array | void {
            ...
            if (this.token_pairs.length)
                writer.writeRepeatedMessage(2, this.token_pairs, (item: dependency_1.helios.erc20.v1.TokenPair) => item.serialize(writer));
            if (!w)
            ...
            while (reader.nextField()) {
                ...
                switch (reader.getFieldNumber()) {
                    case 1:
                        ...
                        break;
                    case 2:
                        reader.readMessage(message.token_pairs, () => pb_1.Message.addToRepeatedWrapperField(message, 2, dependency_1.helios.erc20.v1.TokenPair.deserialize(reader), dependency_1.helios.erc20.v1.TokenPair));
                        break;
