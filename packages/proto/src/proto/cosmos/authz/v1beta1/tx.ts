...
export const MsgExecCompatResponse: MessageFns<MsgExecCompatResponse> = {
  encode(message: MsgExecCompatResponse, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    for (const v of message.results) {
      writer.uint32(10).bytes(v!);
    }
    return writer;
  ...
  create<I extends Exact<DeepPartial<MsgExecCompatResponse>, I>>(base?: I): MsgExecCompatResponse {
    return MsgExecCompatResponse.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgExecCompatResponse>, I>>(object: I): MsgExecCompatResponse {
    const message = createBaseMsgExecCompatResponse();
    message.results = object.results?.map((e) => e) || [];
    return message;
  },
...
export const MsgExecCompat: MessageFns<MsgExecCompat> = {
  encode(message: MsgExecCompat, writer: BinaryWriter = new BinaryWriter()): BinaryWriter {
    if (message.grantee !== "") {
      writer.uint32(10).string(message.grantee);
    }
    for (const v of message.msgs) {
  ...
  create<I extends Exact<DeepPartial<MsgExecCompat>, I>>(base?: I): MsgExecCompat {
    return MsgExecCompat.fromPartial(base ?? ({} as any));
  },
  fromPartial<I extends Exact<DeepPartial<MsgExecCompat>, I>>(object: I): MsgExecCompat {
    const message = createBaseMsgExecCompat();
    message.grantee = object.grantee ?? "";
...
export class MsgClientImpl implements Msg {
  ...
  ExecCompat(request: MsgExecCompat): Promise<MsgExecCompatResponse> {
    ...
    const promise = this.rpc.request(this.service, "ExecCompat", data);
